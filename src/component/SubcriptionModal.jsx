...
export default function SubscriptionModal({
  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      if (!response.ok) throw new Error(await response.text() || "Payment initiation failed");
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black/50 z-50 overflow-y-auto">
      <div className="bg-white rounded-2xl overflow-hidden w-[90%] max-w-[640px] mx-auto shadow-xl">
        ...
        {/* Name & verified badge */}
        <div className="px-6 mt-2 ml-24 flex items-center gap-1">
