...
export default function SubscriptionModal({
  ...
  // Email validation regex for full email format (e.g., example@gmail.com)
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black/50 z-50 overflow-y-auto">
      <div className="bg-white rounded-2xl overflow-hidden w-[90%] max-w-[640px] mx-auto shadow-xl">
        ...
        {/* Name & handle with verified badge to the right of the name */}
        <div className="px-6 mt-2 ml-24">
          <div className="flex items-center gap-2">
            ...
            {/* Verified badge SVG (JSX-friendly attributes) */}
          ...
          <p className="text-sm text-gray-500 mt-1">{creator?.handle || "@username"}</p>
        </div>
        ...
        <div className="px-6 pb-6">
          ...
          {/* Add payment button - Now handles payment initiation (changed text to "Please add a payment card") */}
          <div className="mt-6">
            <button
              ...
              aria-disabled={!selectedPlan || !isValidEmail(email) || isLoading}
            >
