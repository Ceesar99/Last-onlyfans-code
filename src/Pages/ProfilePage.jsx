...
export default function SafeProfileMock() {
  ...
  useEffect(() => {
    console.log("🔄 ProfilePage useEffect starting!");
    let mounted = true;
    ...
    <div style={{ width: "100%", aspectRatio: "1614 / 843", display: "flex", alignItems: "center", justifyContent: "center" }}>
      <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 1614 843" preserveAspectRatio="xMidYMid meet" style={{ width: "100%", height: "100%", objectFit: "contain" }}>
        <g id="dd4789b5-03b7-41b2-a148-534740596f4f">
          <rect style={{ stroke: "rgb(193,193,193)", strokeWidth: 0, fill: "rgb(255,255,255)" }} x="-807" y="-421.5" width="1614" height="843" transform="matrix(1 0 0 1 807 421.5)" />
        </g>
        <g id="ca9d0540-29e7-4418-be31-bf455c24c7ce">
          <image xlinkHref="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mNk+M9QDwADhgGAWjR9awAAAABJRU5ErkJggg=="
            x="-360"
            y="-189.5" 
            width="720" 
            height="379" 
