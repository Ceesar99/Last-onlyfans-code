    ...
    const loadInitialData = async () => {
      try {
        ...
        if (postsError) {
          ...
          // Strategy: Keep local dummy posts always. Add DB posts on top (DB posts first, then dummies (so DB appears at top)
          setPosts((prev) => {
  ...
  return (
    <ErrorBoundary>
      <div className="min-h-screen bg-gray-100 flex justify-center p-4">
        <div className="w-full bg-white text-[15px] relative profile-card" style={{ maxHeight: "calc(100vh - 2rem)", overflowY: "auto" }}>
          {/* COVER */}
