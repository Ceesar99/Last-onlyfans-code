  ...
  const handleMic = async () => {
    if (isRecording) {
      ...
      try {
        ...
        recorder.start(1000); // Timeslice for periodic dataavailable
      } catch (e) {
